...
automode_interfaces__action__Behavior_Goal__init(automode_interfaces__action__Behavior_Goal * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->behavior_name)) {
    automode_interfaces__action__Behavior_Goal__fini(msg);
    return false;
  }
  // params
...
automode_interfaces__action__Behavior_Goal__create(void)
{
  ...
  automode_interfaces__action__Behavior_Goal * msg = (automode_interfaces__action__Behavior_Goal *)allocator.allocate(sizeof(automode_interfaces__action__Behavior_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(automode_interfaces__action__Behavior_Goal));
  bool success = automode_interfaces__action__Behavior_Goal__init(msg);
  if (!success) {
...
automode_interfaces__action__Behavior_Goal__Sequence__init(automode_interfaces__action__Behavior_Goal__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  automode_interfaces__action__Behavior_Goal * data = NULL;

  if (size) {
    data = (automode_interfaces__action__Behavior_Goal *)allocator.zero_allocate(size, sizeof(automode_interfaces__action__Behavior_Goal), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = automode_interfaces__action__Behavior_Goal__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        automode_interfaces__action__Behavior_Goal__fini(&data[i - 1]);
      }
...
automode_interfaces__action__Behavior_Goal__Sequence__fini(automode_interfaces__action__Behavior_Goal__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      automode_interfaces__action__Behavior_Goal__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  automode_interfaces__action__Behavior_Goal__Sequence * array = (automode_interfaces__action__Behavior_Goal__Sequence *)allocator.allocate(sizeof(automode_interfaces__action__Behavior_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = automode_interfaces__action__Behavior_Goal__Sequence__init(array, size);
  if (!success) {
...
automode_interfaces__action__Behavior_Goal__Sequence__destroy(automode_interfaces__action__Behavior_Goal__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    automode_interfaces__action__Behavior_Goal__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
automode_interfaces__action__Behavior_Goal__Sequence__are_equal(const automode_interfaces__action__Behavior_Goal__Sequence * lhs, const automode_interfaces__action__Behavior_Goal__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!automode_interfaces__action__Behavior_Goal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  automode_interfaces__action__Behavior_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(automode_interfaces__action__Behavior_Goal);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    automode_interfaces__action__Behavior_Goal * data =
      (automode_interfaces__action__Behavior_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!automode_interfaces__action__Behavior_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          automode_interfaces__action__Behavior_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!automode_interfaces__action__Behavior_Goal__copy(
...
automode_interfaces__action__Behavior_Result__init(automode_interfaces__action__Behavior_Result * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->message)) {
    automode_interfaces__action__Behavior_Result__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  automode_interfaces__action__Behavior_Result * msg = (automode_interfaces__action__Behavior_Result *)allocator.allocate(sizeof(automode_interfaces__action__Behavior_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(automode_interfaces__action__Behavior_Result));
  bool success = automode_interfaces__action__Behavior_Result__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
automode_interfaces__action__Behavior_Result__Sequence__init(automode_interfaces__action__Behavior_Result__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  automode_interfaces__action__Behavior_Result * data = NULL;

  if (size) {
    data = (automode_interfaces__action__Behavior_Result *)allocator.zero_allocate(size, sizeof(automode_interfaces__action__Behavior_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = automode_interfaces__action__Behavior_Result__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        automode_interfaces__action__Behavior_Result__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
automode_interfaces__action__Behavior_Result__Sequence__fini(automode_interfaces__action__Behavior_Result__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      automode_interfaces__action__Behavior_Result__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  automode_interfaces__action__Behavior_Result__Sequence * array = (automode_interfaces__action__Behavior_Result__Sequence *)allocator.allocate(sizeof(automode_interfaces__action__Behavior_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = automode_interfaces__action__Behavior_Result__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
automode_interfaces__action__Behavior_Result__Sequence__destroy(automode_interfaces__action__Behavior_Result__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    automode_interfaces__action__Behavior_Result__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
automode_interfaces__action__Behavior_Result__Sequence__are_equal(const automode_interfaces__action__Behavior_Result__Sequence * lhs, const automode_interfaces__action__Behavior_Result__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!automode_interfaces__action__Behavior_Result__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  automode_interfaces__action__Behavior_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(automode_interfaces__action__Behavior_Result);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    automode_interfaces__action__Behavior_Result * data =
      (automode_interfaces__action__Behavior_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!automode_interfaces__action__Behavior_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          automode_interfaces__action__Behavior_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!automode_interfaces__action__Behavior_Result__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  automode_interfaces__action__Behavior_Feedback * msg = (automode_interfaces__action__Behavior_Feedback *)allocator.allocate(sizeof(automode_interfaces__action__Behavior_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(automode_interfaces__action__Behavior_Feedback));
  bool success = automode_interfaces__action__Behavior_Feedback__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
automode_interfaces__action__Behavior_Feedback__destroy(automode_interfaces__action__Behavior_Feedback * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    automode_interfaces__action__Behavior_Feedback__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
automode_interfaces__action__Behavior_Feedback__Sequence__init(automode_interfaces__action__Behavior_Feedback__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  automode_interfaces__action__Behavior_Feedback * data = NULL;

  if (size) {
    data = (automode_interfaces__action__Behavior_Feedback *)allocator.zero_allocate(size, sizeof(automode_interfaces__action__Behavior_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = automode_interfaces__action__Behavior_Feedback__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        automode_interfaces__action__Behavior_Feedback__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
automode_interfaces__action__Behavior_Feedback__Sequence__fini(automode_interfaces__action__Behavior_Feedback__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      automode_interfaces__action__Behavior_Feedback__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  automode_interfaces__action__Behavior_Feedback__Sequence * array = (automode_interfaces__action__Behavior_Feedback__Sequence *)allocator.allocate(sizeof(automode_interfaces__action__Behavior_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = automode_interfaces__action__Behavior_Feedback__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
automode_interfaces__action__Behavior_Feedback__Sequence__destroy(automode_interfaces__action__Behavior_Feedback__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    automode_interfaces__action__Behavior_Feedback__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
automode_interfaces__action__Behavior_Feedback__Sequence__are_equal(const automode_interfaces__action__Behavior_Feedback__Sequence * lhs, const automode_interfaces__action__Behavior_Feedback__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!automode_interfaces__action__Behavior_Feedback__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  automode_interfaces__action__Behavior_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(automode_interfaces__action__Behavior_Feedback);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    automode_interfaces__action__Behavior_Feedback * data =
      (automode_interfaces__action__Behavior_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!automode_interfaces__action__Behavior_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          automode_interfaces__action__Behavior_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!automode_interfaces__action__Behavior_Feedback__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
automode_interfaces__action__Behavior_SendGoal_Request__init(automode_interfaces__action__Behavior_SendGoal_Request * msg)
{
  ...
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    automode_interfaces__action__Behavior_SendGoal_Request__fini(msg);
    return false;
  }
  // goal
  if (!automode_interfaces__action__Behavior_Goal__init(&msg->goal)) {
    automode_interfaces__action__Behavior_SendGoal_Request__fini(msg);
    return false;
  }
  return true;
...
automode_interfaces__action__Behavior_SendGoal_Request__fini(automode_interfaces__action__Behavior_SendGoal_Request * msg)
{
  ...
  // goal
  automode_interfaces__action__Behavior_Goal__fini(&msg->goal);
}
...
automode_interfaces__action__Behavior_SendGoal_Request__are_equal(const automode_interfaces__action__Behavior_SendGoal_Request * lhs, const automode_interfaces__action__Behavior_SendGoal_Request * rhs)
{
  ...
  // goal
  if (!automode_interfaces__action__Behavior_Goal__are_equal(
      &(lhs->goal), &(rhs->goal)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  automode_interfaces__action__Behavior_SendGoal_Request * msg = (automode_interfaces__action__Behavior_SendGoal_Request *)allocator.allocate(sizeof(automode_interfaces__action__Behavior_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(automode_interfaces__action__Behavior_SendGoal_Request));
  bool success = automode_interfaces__action__Behavior_SendGoal_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
automode_interfaces__action__Behavior_SendGoal_Request__Sequence__init(automode_interfaces__action__Behavior_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  automode_interfaces__action__Behavior_SendGoal_Request * data = NULL;

  if (size) {
    data = (automode_interfaces__action__Behavior_SendGoal_Request *)allocator.zero_allocate(size, sizeof(automode_interfaces__action__Behavior_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = automode_interfaces__action__Behavior_SendGoal_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        automode_interfaces__action__Behavior_SendGoal_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
automode_interfaces__action__Behavior_SendGoal_Request__Sequence__fini(automode_interfaces__action__Behavior_SendGoal_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      automode_interfaces__action__Behavior_SendGoal_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  automode_interfaces__action__Behavior_SendGoal_Request__Sequence * array = (automode_interfaces__action__Behavior_SendGoal_Request__Sequence *)allocator.allocate(sizeof(automode_interfaces__action__Behavior_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = automode_interfaces__action__Behavior_SendGoal_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
automode_interfaces__action__Behavior_SendGoal_Request__Sequence__destroy(automode_interfaces__action__Behavior_SendGoal_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    automode_interfaces__action__Behavior_SendGoal_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
automode_interfaces__action__Behavior_SendGoal_Request__Sequence__are_equal(const automode_interfaces__action__Behavior_SendGoal_Request__Sequence * lhs, const automode_interfaces__action__Behavior_SendGoal_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!automode_interfaces__action__Behavior_SendGoal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  automode_interfaces__action__Behavior_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(automode_interfaces__action__Behavior_SendGoal_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    automode_interfaces__action__Behavior_SendGoal_Request * data =
      (automode_interfaces__action__Behavior_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!automode_interfaces__action__Behavior_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          automode_interfaces__action__Behavior_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!automode_interfaces__action__Behavior_SendGoal_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
automode_interfaces__action__Behavior_SendGoal_Response__init(automode_interfaces__action__Behavior_SendGoal_Response * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    automode_interfaces__action__Behavior_SendGoal_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  automode_interfaces__action__Behavior_SendGoal_Response * msg = (automode_interfaces__action__Behavior_SendGoal_Response *)allocator.allocate(sizeof(automode_interfaces__action__Behavior_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(automode_interfaces__action__Behavior_SendGoal_Response));
  bool success = automode_interfaces__action__Behavior_SendGoal_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
automode_interfaces__action__Behavior_SendGoal_Response__Sequence__init(automode_interfaces__action__Behavior_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  automode_interfaces__action__Behavior_SendGoal_Response * data = NULL;

  if (size) {
    data = (automode_interfaces__action__Behavior_SendGoal_Response *)allocator.zero_allocate(size, sizeof(automode_interfaces__action__Behavior_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = automode_interfaces__action__Behavior_SendGoal_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        automode_interfaces__action__Behavior_SendGoal_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
automode_interfaces__action__Behavior_SendGoal_Response__Sequence__fini(automode_interfaces__action__Behavior_SendGoal_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      automode_interfaces__action__Behavior_SendGoal_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  automode_interfaces__action__Behavior_SendGoal_Response__Sequence * array = (automode_interfaces__action__Behavior_SendGoal_Response__Sequence *)allocator.allocate(sizeof(automode_interfaces__action__Behavior_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = automode_interfaces__action__Behavior_SendGoal_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
automode_interfaces__action__Behavior_SendGoal_Response__Sequence__destroy(automode_interfaces__action__Behavior_SendGoal_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    automode_interfaces__action__Behavior_SendGoal_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
automode_interfaces__action__Behavior_SendGoal_Response__Sequence__are_equal(const automode_interfaces__action__Behavior_SendGoal_Response__Sequence * lhs, const automode_interfaces__action__Behavior_SendGoal_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!automode_interfaces__action__Behavior_SendGoal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  automode_interfaces__action__Behavior_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(automode_interfaces__action__Behavior_SendGoal_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    automode_interfaces__action__Behavior_SendGoal_Response * data =
      (automode_interfaces__action__Behavior_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!automode_interfaces__action__Behavior_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          automode_interfaces__action__Behavior_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!automode_interfaces__action__Behavior_SendGoal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
automode_interfaces__action__Behavior_SendGoal_Event__init(automode_interfaces__action__Behavior_SendGoal_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    automode_interfaces__action__Behavior_SendGoal_Event__fini(msg);
    return false;
  }
  // request
  if (!automode_interfaces__action__Behavior_SendGoal_Request__Sequence__init(&msg->request, 0)) {
    automode_interfaces__action__Behavior_SendGoal_Event__fini(msg);
    return false;
  }
  // response
  if (!automode_interfaces__action__Behavior_SendGoal_Response__Sequence__init(&msg->response, 0)) {
    automode_interfaces__action__Behavior_SendGoal_Event__fini(msg);
    return false;
  }
  return true;
...
automode_interfaces__action__Behavior_SendGoal_Event__fini(automode_interfaces__action__Behavior_SendGoal_Event * msg)
{
  ...
  // request
  automode_interfaces__action__Behavior_SendGoal_Request__Sequence__fini(&msg->request);
  // response
  automode_interfaces__action__Behavior_SendGoal_Response__Sequence__fini(&msg->response);
}
...
automode_interfaces__action__Behavior_SendGoal_Event__are_equal(const automode_interfaces__action__Behavior_SendGoal_Event * lhs, const automode_interfaces__action__Behavior_SendGoal_Event * rhs)
{
  ...
  // request
  if (!automode_interfaces__action__Behavior_SendGoal_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!automode_interfaces__action__Behavior_SendGoal_Response__Sequence__are_equal(
  ...
  automode_interfaces__action__Behavior_SendGoal_Event * output)
{
  ...
  // request
  if (!automode_interfaces__action__Behavior_SendGoal_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!automode_interfaces__action__Behavior_SendGoal_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  automode_interfaces__action__Behavior_SendGoal_Event * msg = (automode_interfaces__action__Behavior_SendGoal_Event *)allocator.allocate(sizeof(automode_interfaces__action__Behavior_SendGoal_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(automode_interfaces__action__Behavior_SendGoal_Event));
  bool success = automode_interfaces__action__Behavior_SendGoal_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
automode_interfaces__action__Behavior_SendGoal_Event__Sequence__init(automode_interfaces__action__Behavior_SendGoal_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  automode_interfaces__action__Behavior_SendGoal_Event * data = NULL;

  if (size) {
    data = (automode_interfaces__action__Behavior_SendGoal_Event *)allocator.zero_allocate(size, sizeof(automode_interfaces__action__Behavior_SendGoal_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = automode_interfaces__action__Behavior_SendGoal_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        automode_interfaces__action__Behavior_SendGoal_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
automode_interfaces__action__Behavior_SendGoal_Event__Sequence__fini(automode_interfaces__action__Behavior_SendGoal_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      automode_interfaces__action__Behavior_SendGoal_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  automode_interfaces__action__Behavior_SendGoal_Event__Sequence * array = (automode_interfaces__action__Behavior_SendGoal_Event__Sequence *)allocator.allocate(sizeof(automode_interfaces__action__Behavior_SendGoal_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = automode_interfaces__action__Behavior_SendGoal_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
automode_interfaces__action__Behavior_SendGoal_Event__Sequence__destroy(automode_interfaces__action__Behavior_SendGoal_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    automode_interfaces__action__Behavior_SendGoal_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
automode_interfaces__action__Behavior_SendGoal_Event__Sequence__are_equal(const automode_interfaces__action__Behavior_SendGoal_Event__Sequence * lhs, const automode_interfaces__action__Behavior_SendGoal_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!automode_interfaces__action__Behavior_SendGoal_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  automode_interfaces__action__Behavior_SendGoal_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(automode_interfaces__action__Behavior_SendGoal_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    automode_interfaces__action__Behavior_SendGoal_Event * data =
      (automode_interfaces__action__Behavior_SendGoal_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!automode_interfaces__action__Behavior_SendGoal_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          automode_interfaces__action__Behavior_SendGoal_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!automode_interfaces__action__Behavior_SendGoal_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
automode_interfaces__action__Behavior_GetResult_Request__init(automode_interfaces__action__Behavior_GetResult_Request * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    automode_interfaces__action__Behavior_GetResult_Request__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  automode_interfaces__action__Behavior_GetResult_Request * msg = (automode_interfaces__action__Behavior_GetResult_Request *)allocator.allocate(sizeof(automode_interfaces__action__Behavior_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(automode_interfaces__action__Behavior_GetResult_Request));
  bool success = automode_interfaces__action__Behavior_GetResult_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
automode_interfaces__action__Behavior_GetResult_Request__Sequence__init(automode_interfaces__action__Behavior_GetResult_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  automode_interfaces__action__Behavior_GetResult_Request * data = NULL;

  if (size) {
    data = (automode_interfaces__action__Behavior_GetResult_Request *)allocator.zero_allocate(size, sizeof(automode_interfaces__action__Behavior_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = automode_interfaces__action__Behavior_GetResult_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        automode_interfaces__action__Behavior_GetResult_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
automode_interfaces__action__Behavior_GetResult_Request__Sequence__fini(automode_interfaces__action__Behavior_GetResult_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      automode_interfaces__action__Behavior_GetResult_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  automode_interfaces__action__Behavior_GetResult_Request__Sequence * array = (automode_interfaces__action__Behavior_GetResult_Request__Sequence *)allocator.allocate(sizeof(automode_interfaces__action__Behavior_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = automode_interfaces__action__Behavior_GetResult_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
automode_interfaces__action__Behavior_GetResult_Request__Sequence__destroy(automode_interfaces__action__Behavior_GetResult_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    automode_interfaces__action__Behavior_GetResult_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
automode_interfaces__action__Behavior_GetResult_Request__Sequence__are_equal(const automode_interfaces__action__Behavior_GetResult_Request__Sequence * lhs, const automode_interfaces__action__Behavior_GetResult_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!automode_interfaces__action__Behavior_GetResult_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  automode_interfaces__action__Behavior_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(automode_interfaces__action__Behavior_GetResult_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    automode_interfaces__action__Behavior_GetResult_Request * data =
      (automode_interfaces__action__Behavior_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!automode_interfaces__action__Behavior_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          automode_interfaces__action__Behavior_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!automode_interfaces__action__Behavior_GetResult_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
automode_interfaces__action__Behavior_GetResult_Response__init(automode_interfaces__action__Behavior_GetResult_Response * msg)
{
  ...
  // status
  // result
  if (!automode_interfaces__action__Behavior_Result__init(&msg->result)) {
    automode_interfaces__action__Behavior_GetResult_Response__fini(msg);
    return false;
  }
  return true;
}
...
automode_interfaces__action__Behavior_GetResult_Response__fini(automode_interfaces__action__Behavior_GetResult_Response * msg)
{
  ...
  // status
  // result
  automode_interfaces__action__Behavior_Result__fini(&msg->result);
}
...
automode_interfaces__action__Behavior_GetResult_Response__are_equal(const automode_interfaces__action__Behavior_GetResult_Response * lhs, const automode_interfaces__action__Behavior_GetResult_Response * rhs)
{
  ...
  // result
  if (!automode_interfaces__action__Behavior_Result__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  automode_interfaces__action__Behavior_GetResult_Response * msg = (automode_interfaces__action__Behavior_GetResult_Response *)allocator.allocate(sizeof(automode_interfaces__action__Behavior_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(automode_interfaces__action__Behavior_GetResult_Response));
  bool success = automode_interfaces__action__Behavior_GetResult_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
automode_interfaces__action__Behavior_GetResult_Response__Sequence__init(automode_interfaces__action__Behavior_GetResult_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  automode_interfaces__action__Behavior_GetResult_Response * data = NULL;

  if (size) {
    data = (automode_interfaces__action__Behavior_GetResult_Response *)allocator.zero_allocate(size, sizeof(automode_interfaces__action__Behavior_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = automode_interfaces__action__Behavior_GetResult_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        automode_interfaces__action__Behavior_GetResult_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
automode_interfaces__action__Behavior_GetResult_Response__Sequence__fini(automode_interfaces__action__Behavior_GetResult_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      automode_interfaces__action__Behavior_GetResult_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  automode_interfaces__action__Behavior_GetResult_Response__Sequence * array = (automode_interfaces__action__Behavior_GetResult_Response__Sequence *)allocator.allocate(sizeof(automode_interfaces__action__Behavior_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = automode_interfaces__action__Behavior_GetResult_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
automode_interfaces__action__Behavior_GetResult_Response__Sequence__destroy(automode_interfaces__action__Behavior_GetResult_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    automode_interfaces__action__Behavior_GetResult_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
automode_interfaces__action__Behavior_GetResult_Response__Sequence__are_equal(const automode_interfaces__action__Behavior_GetResult_Response__Sequence * lhs, const automode_interfaces__action__Behavior_GetResult_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!automode_interfaces__action__Behavior_GetResult_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  automode_interfaces__action__Behavior_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(automode_interfaces__action__Behavior_GetResult_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    automode_interfaces__action__Behavior_GetResult_Response * data =
      (automode_interfaces__action__Behavior_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!automode_interfaces__action__Behavior_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          automode_interfaces__action__Behavior_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!automode_interfaces__action__Behavior_GetResult_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
automode_interfaces__action__Behavior_GetResult_Event__init(automode_interfaces__action__Behavior_GetResult_Event * msg)
{
  ...
  // info
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    automode_interfaces__action__Behavior_GetResult_Event__fini(msg);
    return false;
  }
  // request
  if (!automode_interfaces__action__Behavior_GetResult_Request__Sequence__init(&msg->request, 0)) {
    automode_interfaces__action__Behavior_GetResult_Event__fini(msg);
    return false;
  }
  // response
  if (!automode_interfaces__action__Behavior_GetResult_Response__Sequence__init(&msg->response, 0)) {
    automode_interfaces__action__Behavior_GetResult_Event__fini(msg);
    return false;
  }
  return true;
...
automode_interfaces__action__Behavior_GetResult_Event__fini(automode_interfaces__action__Behavior_GetResult_Event * msg)
{
  ...
  service_msgs__msg__ServiceEventInfo__fini(&msg->info);
  // request
  automode_interfaces__action__Behavior_GetResult_Request__Sequence__fini(&msg->request);
  // response
  automode_interfaces__action__Behavior_GetResult_Response__Sequence__fini(&msg->response);
}
...
automode_interfaces__action__Behavior_GetResult_Event__are_equal(const automode_interfaces__action__Behavior_GetResult_Event * lhs, const automode_interfaces__action__Behavior_GetResult_Event * rhs)
{
  ...
  // request
  if (!automode_interfaces__action__Behavior_GetResult_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!automode_interfaces__action__Behavior_GetResult_Response__Sequence__are_equal(
      &(lhs->response), &(rhs->response)))
  {
    return false;
  }
  ...
  automode_interfaces__action__Behavior_GetResult_Event * output)
{
  ...
  // request
  if (!automode_interfaces__action__Behavior_GetResult_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!automode_interfaces__action__Behavior_GetResult_Response__Sequence__copy(
      &(input->response), &(output->response)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  automode_interfaces__action__Behavior_GetResult_Event * msg = (automode_interfaces__action__Behavior_GetResult_Event *)allocator.allocate(sizeof(automode_interfaces__action__Behavior_GetResult_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(automode_interfaces__action__Behavior_GetResult_Event));
  bool success = automode_interfaces__action__Behavior_GetResult_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
automode_interfaces__action__Behavior_GetResult_Event__Sequence__init(automode_interfaces__action__Behavior_GetResult_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  automode_interfaces__action__Behavior_GetResult_Event * data = NULL;

  if (size) {
    data = (automode_interfaces__action__Behavior_GetResult_Event *)allocator.zero_allocate(size, sizeof(automode_interfaces__action__Behavior_GetResult_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = automode_interfaces__action__Behavior_GetResult_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        automode_interfaces__action__Behavior_GetResult_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
automode_interfaces__action__Behavior_GetResult_Event__Sequence__fini(automode_interfaces__action__Behavior_GetResult_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      automode_interfaces__action__Behavior_GetResult_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  automode_interfaces__action__Behavior_GetResult_Event__Sequence * array = (automode_interfaces__action__Behavior_GetResult_Event__Sequence *)allocator.allocate(sizeof(automode_interfaces__action__Behavior_GetResult_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = automode_interfaces__action__Behavior_GetResult_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
automode_interfaces__action__Behavior_GetResult_Event__Sequence__destroy(automode_interfaces__action__Behavior_GetResult_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    automode_interfaces__action__Behavior_GetResult_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
automode_interfaces__action__Behavior_GetResult_Event__Sequence__are_equal(const automode_interfaces__action__Behavior_GetResult_Event__Sequence * lhs, const automode_interfaces__action__Behavior_GetResult_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!automode_interfaces__action__Behavior_GetResult_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  automode_interfaces__action__Behavior_GetResult_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(automode_interfaces__action__Behavior_GetResult_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    automode_interfaces__action__Behavior_GetResult_Event * data =
      (automode_interfaces__action__Behavior_GetResult_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!automode_interfaces__action__Behavior_GetResult_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          automode_interfaces__action__Behavior_GetResult_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!automode_interfaces__action__Behavior_GetResult_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
automode_interfaces__action__Behavior_FeedbackMessage__init(automode_interfaces__action__Behavior_FeedbackMessage * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    automode_interfaces__action__Behavior_FeedbackMessage__fini(msg);
    return false;
  }
  // feedback
  if (!automode_interfaces__action__Behavior_Feedback__init(&msg->feedback)) {
    automode_interfaces__action__Behavior_FeedbackMessage__fini(msg);
    return false;
  }
  return true;
...
automode_interfaces__action__Behavior_FeedbackMessage__fini(automode_interfaces__action__Behavior_FeedbackMessage * msg)
{
  ...
  unique_identifier_msgs__msg__UUID__fini(&msg->goal_id);
  // feedback
  automode_interfaces__action__Behavior_Feedback__fini(&msg->feedback);
}
...
automode_interfaces__action__Behavior_FeedbackMessage__are_equal(const automode_interfaces__action__Behavior_FeedbackMessage * lhs, const automode_interfaces__action__Behavior_FeedbackMessage * rhs)
{
  ...
  // feedback
  if (!automode_interfaces__action__Behavior_Feedback__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  automode_interfaces__action__Behavior_FeedbackMessage * msg = (automode_interfaces__action__Behavior_FeedbackMessage *)allocator.allocate(sizeof(automode_interfaces__action__Behavior_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(automode_interfaces__action__Behavior_FeedbackMessage));
  bool success = automode_interfaces__action__Behavior_FeedbackMessage__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
automode_interfaces__action__Behavior_FeedbackMessage__Sequence__init(automode_interfaces__action__Behavior_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  automode_interfaces__action__Behavior_FeedbackMessage * data = NULL;

  if (size) {
    data = (automode_interfaces__action__Behavior_FeedbackMessage *)allocator.zero_allocate(size, sizeof(automode_interfaces__action__Behavior_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = automode_interfaces__action__Behavior_FeedbackMessage__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        automode_interfaces__action__Behavior_FeedbackMessage__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
automode_interfaces__action__Behavior_FeedbackMessage__Sequence__fini(automode_interfaces__action__Behavior_FeedbackMessage__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      automode_interfaces__action__Behavior_FeedbackMessage__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  automode_interfaces__action__Behavior_FeedbackMessage__Sequence * array = (automode_interfaces__action__Behavior_FeedbackMessage__Sequence *)allocator.allocate(sizeof(automode_interfaces__action__Behavior_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = automode_interfaces__action__Behavior_FeedbackMessage__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
automode_interfaces__action__Behavior_FeedbackMessage__Sequence__destroy(automode_interfaces__action__Behavior_FeedbackMessage__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    automode_interfaces__action__Behavior_FeedbackMessage__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
automode_interfaces__action__Behavior_FeedbackMessage__Sequence__are_equal(const automode_interfaces__action__Behavior_FeedbackMessage__Sequence * lhs, const automode_interfaces__action__Behavior_FeedbackMessage__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!automode_interfaces__action__Behavior_FeedbackMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  automode_interfaces__action__Behavior_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(automode_interfaces__action__Behavior_FeedbackMessage);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    automode_interfaces__action__Behavior_FeedbackMessage * data =
      (automode_interfaces__action__Behavior_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!automode_interfaces__action__Behavior_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          automode_interfaces__action__Behavior_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!automode_interfaces__action__Behavior_FeedbackMessage__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
