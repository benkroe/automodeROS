...
class Condition(ConditionBase):
    ...
    def get_description() -> Dict[str, Any]:
        return {
            "name": "white_floor",
            "type": 2,
            "description": "Triggers when white floor is detected (or not detected) with probability (p)",
            "params": [
